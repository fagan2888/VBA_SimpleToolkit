...
Public Function fexStrBtw(strTarget As String, strBegin As String, strEnd As String) As String

    fexStrBtw = Replace(Split(Split(strTarget, strBegin)(1), strEnd)(0), " ", "")
